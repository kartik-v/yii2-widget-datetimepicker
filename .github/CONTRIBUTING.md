Contributing to yii2-widget-datetimepicker
==========================================
Looking to contribute something to yii2-widget-datetimepicker? **Here's how you can help.**
...
[extension documentation and demos](http://demos.krajee.com/widget-details/datetimepicker) and/or refer to the
[webtips Q & A forum](http://webtips.krajee.com/questions) which are the better places to get help.

Reporting bugs with yii2-widget-datetimepicker
----------------------------------------------
We really appreciate clear bug reports that _consistently_ show an issue
_within yii2-widget-datetimepicker_.
...
- What version of jQuery are you using? And what version of yii2-widget-datetimepicker?
- Are you using yii2-widget-datetimepicker with other plugins?

All of these questions will help others fix and identify any potential bugs.

Requesting features in yii2-widget-datetimepicker
------------------------------------------
Before starting work on a major feature for yii2-widget-datetimepicker, **read the
[documentation](http://demos.krajee.com/widget-details/datetimepicker)  first** or you may risk spending a considerable amount of
...
yii2-widget-datetimepicker regularly receives new issues which need to be tested and organized.
...
If you can test issues that are reported to yii2-widget-datetimepicker that contain test cases and
...
It should also be made clear that **all code contributed to yii2-widget-datetimepicker** must be
licensable under the [BSD-3 license][licensing].  Code that cannot be released
under this license **cannot be accepted** into the project.

[issue-search]: https://github.com/kartik-v/yii2-widget-datetimepicker/search?q=&type=Issues
[issue-tracker]: https://github.com/kartik-v/yii2-widget-datetimepicker/issues
[licensing]: https://github.com/kartik-v/yii2-widget-datetimepicker/blob/master/LICENSE.md
[reporting-bugs]: #reporting-bugs-with-yii2-widget-datetimepicker
[requesting-features]: #requesting-features-in-yii2-widget-datetimepicker